...
public class asdFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new asdFrame().setVisible(true); //to show the design once project run
            }
        });
    }
   ...
   private ArrayList<Invoiceheader11> invoices;
    ...
    private InvoiceheaderTable invoiceHeaderTableModel;


    public ArrayList<Invoiceheader11> getInvoices() 
    {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoices(ArrayList<Invoiceheader11> invoices) {
        this.invoices = invoices;
    }

    public InvoiceheaderTable getInvoicesTableModel() {
        if (invoiceHeaderTableModel == null) {
            invoiceHeaderTableModel = new InvoiceheaderTable(getInvoices());
        }
    ...
    public JTable getInvoiceTable() {
        JTable invoiceTable = null;
        return invoiceTable;
    }

    public JLabel getInvoiceTotalLabel() {
        JLabel invoiceTotalLabel = null;
        return invoiceTotalLabel;
    }

    public JTable getLineTable() {
        JTable lineTable = null;
        return lineTable;
    }
    ...
    public int getNextInvoiceNum()
    {
        ...
        for (Invoiceheader11 invoice : getInvoices())
        {
